...
var ASM_CONSTS = {
  3969296: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3969357: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3969421: function() {return Module.webglContextAttributes.powerPreference;},  
 3969479: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3969534: function($0) {performance.now = function() { return $0; };},  
 3969582: function($0) {performance.now = function() { return $0; };},  
 3969630: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _emscripten_resize_heap(requestedSize) {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        var overGrownHeapSize = oldSize * (1 + 0.25 / cutDown); // ensure geometric growth
